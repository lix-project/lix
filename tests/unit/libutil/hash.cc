...
namespace nix {
    ...
    TEST(hashString, testKnownMD5Hashes1) {
        ...
        ASSERT_EQ(hash.to_base16(), "md5:d41d8cd98f00b204e9800998ecf8427e");
    }
    ...
    TEST(hashString, testKnownMD5Hashes2) {
        ...
        ASSERT_EQ(hash.to_base16(), "md5:900150983cd24fb0d6963f7d28e17f72");
    }
    ...
    TEST(hashString, testKnownSHA1Hashes1) {
        ...
        ASSERT_EQ(hash.to_base16(), "sha1:a9993e364706816aba3e25717850c26c9cd0d89d");
    }
    ...
    TEST(hashString, testKnownSHA1Hashes2) {
        ...
        auto hash = hashString(HashType::SHA1, s);
        ASSERT_EQ(hash.to_base16(), "sha1:84983e441c3bd26ebaae4aa1f95129e5e54670f1");
    }
    ...
    TEST(hashString, testKnownSHA256Hashes1) {
        ...
        ASSERT_EQ(
            hash.to_base16(), "sha256:ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad"
        );
    }
    ...
    TEST(hashString, testKnownSHA256Hashes2) {
        ...
        auto hash = hashString(HashType::SHA256, s);
        ASSERT_EQ(
            hash.to_base16(), "sha256:248d6a61d20638b8e5c026930c3e6039a33ce45964ff2167f6ecedd419db06c1"
        );
    }
